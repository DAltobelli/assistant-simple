...
const AuthorizationV1 = require("watson-developer-cloud/authorization/v1"); // for Web side
const AssistantV1 = require("watson-developer-cloud/assistant/v1"); // assistant sdk
const SpeechToTextV1 = require("watson-developer-cloud/speech-to-text/v1"); // speech sdk
...
// Endpoint to be call from the client side
app.get("/api/get_audio_token", function(req, res) {
  sttAuthService.getToken(
    ...
    (err, token) => {
      if (err) {
        console.error("[SPEECH TOKEN]", error);
